...
insert
into ad (publisher_ad_key, publisher_id, updated_at, published_at, category, author, url,
...
values ('wzqmlftl', (select id from divar_publisher), now(), '2024-11-05 18:00:00', 'mortgage', 'آژانس نگین اندرزگو',
        ...
        'apartment', 120, 2, 1396, 4, 11, true, true, true, 35.805331, 51.440023),
       ('445904922', (select id from sheypoor_publisher), now(), '2024-11-05 15:00:00', 'buy', 'کاربر شیپور',
        ...
        'محمودآباد', 'تشبندان', 'villa', 350, 3, 1402, 0, 0, true, false, false, 0, 0);
...
values ('319280055', (select id from ad where publisher_ad_key = 'wzqmlftl')),
